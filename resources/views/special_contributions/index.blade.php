...
<div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4 gap-3">
    <div>
        ...
        <div class="text-muted">Record purpose-driven contributions (min GHS 200).</div>
    </div>
            ...
            <div class="card-body">
                <form action="{{ route('special-contributions.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Amount (min GHS 200)</label>
                            <input type="number" step="0.01" name="amount" class="form-control" value="{{ old('amount', 200) }}" required>
                        </div>
                        <div class="col-md-6">
