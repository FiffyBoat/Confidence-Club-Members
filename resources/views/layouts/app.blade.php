...
<div class="app-shell d-flex flex-column flex-lg-row">
    ...
    <div class="sidebar text-white p-3">
        ...
        @guest
            <a href="{{ route('login') }}" class="sidebar-link"><i class="bi bi-box-arrow-in-right"></i>Login</a>
        @endguest
        @if(auth()->check() && auth()->user()->role === 'admin')
            <a href="{{ route('admin.dashboard') }}" class="sidebar-link {{ request()->routeIs('admin.*') ? 'active' : '' }}"><i class="bi bi-gear"></i>Settings</a>
        @endif
    </div>
