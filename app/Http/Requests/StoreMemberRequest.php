...
class StoreMemberRequest extends FormRequest
{
    ...
    {
        return [
            'membership_id' => ['required', 'string', 'max:40', 'unique:members,membership_id'],
            ...
            'admission_payment_method' => ['required_if:record_admission_fee,1', 'in:cash,momo,bank,card'],
            'admission_transaction_date' => ['required_if:record_admission_fee,1', 'date'],
        ];
    }
